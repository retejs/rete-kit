...
export type DefaultTemplateKey = 'zoom-at' | 'react-render' | 'react18' | 'vue-render' | `vue${2 | 3}` | 'angular-render' | `angular${AngularVersion}` | 'svelte-render' | `svelte${3 | 4}` | 'lit-render' | `lit${3}` | 'dataflow' | 'arrange' | 'sizes' | 'readonly' | 'order-nodes' | 'selectable' | 'context-menu' | 'import-area-extensions' | 'minimap' | 'reroute' | `stack-${string}`;
